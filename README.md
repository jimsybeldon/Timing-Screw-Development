...
> 
> Parasolid and any other kernal is limited to the analytical for cutter models.
> 
> CAM systems do not produce a cad model, but allow realworld motion to cut material that is accurate.   One gets physical results from machining rather than a analytical model in CAD. 
> 
> An STL model creation would be possible from CMM measurements from that physical model, but not from an accurate CAD model source.
> 
> This is particularly true of complex cutter shapes that are not simple extrusion or revolution models, and/or not having the cutter tool moving with complex traslations/rotations.
> 
> ## (It would be great to be proven wrong.  I suspect the use case for high grade cad models is mariginal.  CAM does it.)
---
